...
try {
    Write-Host "🔧 Creating performance test project..." -ForegroundColor Yellow
    ...
    # Add packages
    dotnet add package Microsoft.Extensions.Hosting | Out-Null
    ...
    # Run simple performance metrics
